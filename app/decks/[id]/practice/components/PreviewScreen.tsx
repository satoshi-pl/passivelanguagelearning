      ...
      <div className="pll-workspace mx-auto max-w-5xl xl:max-w-6xl px-4 pt-1 pb-4 sm:px-6 sm:pt-4 sm:pb-6 md:py-6">
        <div className="preview-shell rounded-2xl border border-black/5 bg-white/80 p-4 shadow-sm backdrop-blur sm:p-6 lg:p-7">
          <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="flex flex-wrap items-stretch gap-2 max-sm:grid max-sm:grid-cols-2 max-sm:gap-1.5 lg:justify-end">
              {showWordsTable && (
                <>
                  <button
                    type="button"
                    onClick={() => setShowTranslations(!showTranslations)}
                    className="preview-control-button preview-control-button--text min-h-11 rounded-xl border border-black/10 px-3 py-2 text-sm hover:bg-black/5 max-sm:col-span-1 max-sm:w-full max-sm:min-h-10 max-sm:px-2.5 max-sm:py-1.5 max-sm:justify-center"
                    title={
                      showTranslations
                        ? "Hide translation (H)"
                        : "Show translation (S)"
                  ...
                  <button
                    ...
                    className="preview-control-button preview-control-button--speed min-h-11 rounded-xl border border-black/10 px-3 py-2 text-sm hover:bg-black/5 max-sm:col-span-1 max-sm:w-full max-sm:min-h-10 max-sm:px-2.5 max-sm:py-1.5 max-sm:justify-center"
                  ...
                  <button
                    ...
                    className="preview-control-button preview-control-button--playall min-h-11 rounded-xl border border-black/10 px-3 py-2 text-sm hover:bg-black/5 disabled:opacity-50 max-sm:col-span-1 max-sm:w-full max-sm:min-h-10 max-sm:px-2.5 max-sm:py-1.5 max-sm:justify-center"
                    title="Play all (A)"
                  >
